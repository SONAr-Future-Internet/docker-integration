...
case ${1,,} in
	...
	asb)  	target="administration-service-bus" ;;
	csb)  	target="customer-service-bus" ;;
	isb)  	target="integration-service-bus" ;;
	...
	administration-service-bus)  		target="administration-service-bus" ;;
	customer-service-bus)  				target="customer-service-bus" ;;
	integration-service-bus)  			target="integration-service-bus" ;;
	...
	administration-bus)  	target="administration-service-bus" ;;
	customer-bus)  			target="customer-service-bus" ;;
	integration-bus)  		target="integration-service-bus" ;;
